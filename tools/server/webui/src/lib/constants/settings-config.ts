...
export const SETTING_CONFIG_INFO: Record<string, string> = {
	...
	thinking_budget_tokens:
		'Controls the maximum number of tokens the model can use for reasoning/thinking. Unlimited (0) = no budget limit, Low (256) = brief reasoning, Medium (512) = moderate reasoning, High (1024) = extended reasoning.',
	enable_thinking:
		'Enable or disable thinking/reasoning mode for reasoning models. When disabled, the model will not generate thinking tokens.',
