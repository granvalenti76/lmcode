...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--metrics-file"}, "PATH",
        "log metrics to file in JSON Lines format (default: disabled)",
        [](common_params & params, const std::string & value) {
            params.metrics_file = value;
        }
    ).set_examples({LLAMA_EXAMPLE_SERVER}).set_env("LLAMA_METRICS_FILE"));
    add_opt(common_arg(
        {"--props"},
    ...
    add_opt(common_arg(
        ...
        "- auto: automatically detect from template (default)\n"
